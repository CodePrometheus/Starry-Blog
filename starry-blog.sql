...
INSERT INTO `tb_article` VALUES (30, 1, 10, 'https://unsplash.it/600/400?random=2', '2021-08-22', 'eded', 1, '', 1, 0, 1, '2021-08-22 16:54:08', '2021-12-13 10:59:25');
...
INSERT INTO `tb_article_tag` VALUES (126, 14, 1);
INSERT INTO `tb_article_tag` VALUES (127, 30, 12);
...
CREATE TABLE `tb_moment`  (
  ...
  `is_publish` bit(1) NOT NULL COMMENT '是否公开',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `tb_moment` VALUES (1, 'test', '2020-01-08 22:57:00', 5, b'1');
...
CREATE TABLE `tb_page`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 903 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '页面' ROW_FORMAT = DYNAMIC;
...
-- Records of tb_role
-- ----------------------------
INSERT INTO `tb_role` VALUES (1, '管理员', 'admin', 0, '2021-01-11 17:21:57', '2021-03-20 23:27:55');
INSERT INTO `tb_role` VALUES (2, '用户', 'user', 0, '2021-01-11 20:17:05', '2021-03-16 23:20:20');
INSERT INTO `tb_role` VALUES (3, '测试', 'test', 0, '2021-01-11 20:17:23', '2021-03-16 23:41:59');
...
CREATE TABLE `tb_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2310 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `tb_role_resource`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4177 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `tb_user_auth` VALUES (1, 1, '2413245708@qq.com', '$2a$10$DzvvQ73tQ86AtSKSiINuqel4cCfXRgCl8LZf/Jm7jGCaHjM4mjG3u', 0, '192.168.2.16', ' 局域网', '2020-12-22 23:13:43', '2022-01-04 00:25:28', '2022-01-04 00:25:27');
...
-- ----------------------------
INSERT INTO `tb_visit_log` VALUES (2, '/', NULL, '查看博客信息', '192.168.2.16', ' 局域网', NULL, NULL, 'CHROME9', 'WINDOWS_10', 'GET', '{}', '200', '2022-01-04 08:13:20', NULL);
INSERT INTO `tb_visit_log` VALUES (3, '/articles', NULL, '查看首页文章', '192.168.2.16', ' 局域网', NULL, NULL, 'CHROME9', 'WINDOWS_10', 'GET', '{\"current\":[\"1\"]}', '200', '2022-01-04 08:13:24', NULL);
INSERT INTO `tb_visit_log` VALUES (4, '/articles', NULL, '查看首页文章', '192.168.2.16', ' 局域网', NULL, NULL, 'CHROME9', 'WINDOWS_10', 'GET', '{\"current\":[\"2\"]}', '200', '2022-01-04 08:13:32', NULL);
INSERT INTO `tb_visit_log` VALUES (5, '/comments', NULL, '查询评论', '192.168.2.16', ' 局域网', NULL, NULL, 'Chrome 9', 'Windows 10', 'GET', '{\"current\":[\"1\"],\"articleId\":[\"14\"]}', '200', '2022-01-04 08:22:22', NULL);
INSERT INTO `tb_visit_log` VALUES (6, '/comments', NULL, '查询评论', '192.168.2.16', ' 局域网', NULL, NULL, 'Chrome 9', 'Windows 10', 'GET', '{\"current\":[\"1\"],\"articleId\":[\"21\"]}', '200', '2022-01-04 08:22:55', NULL);
