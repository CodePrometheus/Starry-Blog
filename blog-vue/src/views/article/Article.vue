...
.reward-img-wechat {
  background: url(https://gitee.com/codeprometheus/MyPicBed/raw/master/img/wechat.png) center center / cover
  no-repeat;
...
.reward-img-alipay {
  background: url(https://gitee.com/codeprometheus/MyPicBed/raw/master/img/alipay.jpg) center center / cover
  no-repeat;
  background-color: #49b1f5;
  width: 130px;
  height: 130px;
